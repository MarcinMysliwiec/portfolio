    ...
    <section className="my-28  px-5">
      ...
      <div className="my-7 grid gap-5 grid-cols-3 md:grid-cols-6">
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="Javascript">
          <img src="./assets/icons/javascript-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          Javascript
        </div>
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="React Js">
          <img src="./assets/icons/react-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          React JS
        </div>
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="Node Js">
          <img src="./assets/icons/nodejs-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          Node JS
        </div>
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="MongoDB">
          <img src="./assets/icons/mongodb-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          MongoDB
        </div>
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="HTML 5">
          <img src="./assets/icons/html5-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          HTML 5
        </div>
        <div className="flex flex-col items-center" tabIndex="0" role="img" aria-label="CSS 3">
          <img src="./assets/icons/css3-original.svg" alt="" loading="lazy" className="w-16 mb-1" width="64px"
               height="64px"/>
          CSS 3
        </div>
      </div>
